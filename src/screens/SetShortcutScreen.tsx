...
function SetShortcutScreen() {
    ...
    const { action, shortcut } = route.params;
    ...
    return(
        <SafeAreaView style={tw`px-4 py-2`}>
            ...
            <TouchableOpacity onPress={onPress} disabled={!query} style={tw.style(`bg-black mt-8 py-4 px-4`, !query && `opacity-50`)}>
